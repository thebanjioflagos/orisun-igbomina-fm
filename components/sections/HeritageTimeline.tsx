...
const timelineEvents = [
  {
    year: "Ancient",
    title: "The Descent",
    description: "Oduduwa's descent from heaven, the beginning of the Yoruba race.",
  },
  {
    year: "12th Century",
    title: "Founding of Ila-Orangun",
    description: "Orangun Fagbamila Ajagun-nla establishes the capital of the Igbomina kingdom.",
  },
  {
    year: "19th Century",
    title: "The Golden Era",
    description: "Ila-Orangun emerges as a major center of Yoruba culture and commerce.",
  },
  {
    year: "2024",
    title: "The New Source",
    description: "Orisun Igbomina FM 102.1 is founded to amplify the community's voice.",
  }
];
      ...
      <div ref={triggerRef}>
        <div ref={sectionRef} className="h-screen w-[400vw] flex flex-row relative">
          {timelineEvents.map((event, idx) => (
            <div key={idx} className="h-screen w-screen flex flex-col items-center justify-center px-12 relative">
              <div className="absolute top-1/2 left-0 w-full h-px bg-orisun-gold/20 -z-10" />
              
              {/* Massive background text to fill space */}
              <div className="absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none select-none -z-5 opacity-[0.03]">
